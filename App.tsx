...
const STYLE_PRESETS: StylePreset[] = [
  ...
  { id: 'claymation', name: 'Claymation', prompt: 'STRICT_LOCKDOWN: AARDMAN STOP-MOTION. Play-Doh Diorama. MANDATORY: Entire scene constructed entirely from chunky, vibrant sculpted modeling clay. CRITICAL REQUIREMENT: Erase ALL realistic human faces. Convert ALL humans into abstract, funny-colored clay figures with simple, featureless molded heads or basic dot-eyes. Extremely visible thumbprints and smudges everywhere. Miniature studio lighting. FORBIDDEN: ANY realistic human expressions, realistic eyes, realistic mouths, human skin, or photorealism. Everything must be crude, funny-colored clay.', thumbnail: '🧸' }
];
