...
const STYLE_PRESETS: StylePreset[] = [
  ...
  { id: 'pixel', name: 'Pixel Art', prompt: 'Retro 8-bit video game. Flat 2D pixel art sprite. NO REALISM. NO PHOTOGRAPHY. Convert all humans into blocky, rigid, low-resolution square-pixel sprites. Use a limited 16-color palette.', thumbnail: '👾' },
  ...
  { id: 'ue5', name: '3D Render', prompt: '3D animated Pixar movie. Stylized CGI cartoon. NO REALISM. NO PHOTOGRAPHY. Convert all humans into cute, exaggerated 3D cartoon characters with smooth plastic skin, big cartoon eyes, and soft stylized 3D rendered clothing.', thumbnail: '🎮' },
  ...
  { id: 'claymation', name: 'Claymation', prompt: 'Crude Play-Doh claymation cartoon. NO REALISM. NO PHOTOGRAPHY. NO REAL SKIN. NO REAL FABRIC. Convert EVERYTHING (humans, clothes, background) into chunky, brightly-colored solid modeling clay blobs. Humans must have goofy molded clay faces with simple dot-eyes. Extremely visible thumbprints everywhere.', thumbnail: '🧸' }
];
