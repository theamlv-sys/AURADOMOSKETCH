...
const STYLE_PRESETS: StylePreset[] = [
  ...
  { id: 'cyber', name: 'Cyberpunk', prompt: 'STRICT_LOCKDOWN: CYBER NEON. Futuristic dark aesthetic. MANDATORY: Neon glow, rain reflections, synthetic textures. FORBIDDEN: Natural landscapes, daylight.', thumbnail: '🌆' },
  ...
  { id: 'pixel', name: 'Pixel Art', prompt: 'STRICT_LOCKDOWN: 16-BIT PIXEL ART. Strict square grid. MANDATORY: Blocky aliased textures, limited retro color palette, highly visible distinct pixels. FORBIDDEN: Smooth curves, gradients, realism, high resolution details, photographic elements.', thumbnail: '👾' },
  ...
  { id: 'ue5', name: '3D Render', prompt: 'STRICT_LOCKDOWN: UNREAL ENGINE 5. Ray-traced CGI. MANDATORY: Subsurface scattering, cinematic 3D surfaces, perfect synthetic reflections, highly polished plastic/digital look. FORBIDDEN: 2D drawing, raw photography, real-world imperfections, camera grain.', thumbnail: '🎮' },
  ...
  { id: 'claymation', name: 'Claymation', prompt: 'STRICT_LOCKDOWN: AARDMAN STOP-MOTION. Play-Doh Diorama. MANDATORY: Entire scene constructed entirely from chunky, vibrant sculpted modeling clay. CRITICAL REQUIREMENT: Erase ALL realistic human features. Convert ALL human bodies, faces, and clothing into solid, abstract, funny-colored clay figures with simple, featureless molded heads or basic dot-eyes. Clothing must be thick painted clay, not fabric. Extremely visible thumbprints and smudges everywhere. Miniature studio lighting. FORBIDDEN: ANY realistic human expressions, eyes, mouths, skin, fabric textures, real-world proportions, or photorealism. Everything must be crude, funny-colored clay blobs.', thumbnail: '🧸' }
];
